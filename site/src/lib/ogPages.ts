...
export const ogPages: OgPage[] = [
  ...
  { slug: 'evidence-polling', path: '/evidence/polling/', kicker: 'The evidence', title: 'Polling', summary: 'Support among Democrats, Republicans, and independents for every proposal — and each proposal’s bipartisan floor.' },
  { slug: 'evidence-rejected', path: '/evidence/rejected/', kicker: 'The evidence', title: 'Rejected Categories', summary: 'What could not pass the full-spectrum test, the test each failed, and what would bring it back.' },
  { slug: 'evidence-candidates', path: '/evidence/candidates/', kicker: 'The evidence', title: 'Candidate Categories', summary: 'The open pipeline: ideas under consideration and the evidence that would move each in or out.' },
