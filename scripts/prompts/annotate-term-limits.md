...
PAGE (edit only this file): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/amendments/term-limits.mdx
RESEARCH TERM_LIMITS_RESEARCH.md (the source of the reasoning): /Users/michaelhamilton/Documents/newbillofrights/research/TERM_LIMITS_RESEARCH.md
CANONICAL TEXT: /Users/michaelhamilton/Documents/newbillofrights/research/PROPOSED_AMENDMENTS.md (article "2. Term Limits")
...
{"slug": "term-limits", "sections": <count annotated>, "annotations": [{"section": 1, "text": "<the annotation text>"}, ...], "notes": "<anything the editor should know: a section where the memo gave no reasoning, a place where you were unsure of the trap name, etc.>"}
