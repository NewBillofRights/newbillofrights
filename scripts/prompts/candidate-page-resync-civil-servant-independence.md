...
PAGE (edit only this file): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/candidates/civil-servant-independence.mdx
MEMO (the only source of facts and URLs): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/CIVIL_SERVICE_CANDIDATE.md
...
## Do
- Compare every number, date, count, and claim on the page against the memo as it now stands. Where the memo changed, change the page (prose AND footnote), including the frontmatter `summary` and `gate` if the gate result or floor changed. SPECIFIC CHANGE Additions: H.R. 492 (Saving the Civil Service Act) 108 cosponsors, 104 D / 4 R; S. 134 24 cosponsors, 22 D / 2 I / 0 R; S. 2837 48 cosponsors, 44 D / 2 I / 2 R — the 'majority of both caucuses' route in 'What would move it' is now evidenced as far off. Partnership 2026 party breakdown beyond the R figure confirmed unpublished (trend chart only). Add the legislative point briefly if the page discusses the statutory route. for this page: Additions: H.R. 492 (Saving the Civil Service Act) 108 cosponsors, 104 D / 4 R; S. 134 24 cosponsors, 22 D / 2 I / 0 R; S. 2837 48 cosponsors, 44 D / 2 I / 2 R — the 'majority of both caucuses' route in 'What would move it' is now evidenced as far off. Partnership 2026 party breakdown beyond the R figure confirmed unpublished (trend chart only). Add the legislative point briefly if the page discusses the statutory route.
...
{"slug": "civil-servant-independence", "changed": ["one line per change made"], "gateChanged": <true|false>, "summary": "<final frontmatter summary>", "gate": "<final frontmatter gate>", "words": <body word count>, "flags": ["anything the editor should look at"]}
