...
YOUR CATEGORY: Civil servant independence
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/CIVIL_SERVICE_CANDIDATE.md
...
- Corpus: Partnership for Public Service spring 2025 (nonpartisan civil service important: 67%, down from 87%; R 87→66; I 79→34; 64% of R say president should fill any job with loyalists (up from 33%); 60% of R fire any civil servant for any reason (up from 37%)) via GovExec; AP-NORC March 2025 (~25% favor / ~48% oppose mass eliminations); Partnership March 2025 concern about losing expertise 64% (44R/85D). Verify on Partnership's own pages / AP-NORC. Search for 2026 waves of the Partnership survey and any Pew/AP-NORC/Marquette items on Schedule F / "Schedule Policy/Career", merit protections, and OPM rules; the Supreme Court/legal record (Trump v. Wilcox 2025 stay; the 2025 RIF litigation) as context only.
- This is the corpus's clearest REGIME-CODED case — R support for merit protections dropped ~20 points in one year while a Republican president held the power. Show the trend with dated numbers; note that a floor measured now would likely flip if the presidency changed hands (§11 trap: "same principle, different incumbent") — recommend forward-looking, both-parties wording for any re-poll.
- Also the UMD PPC finding that extending a stock-trading ban to all federal employees drops support to 40% (verify) — the public does not extend accountability instincts to the civil service.
- Contributor draft: AMENDMENT_IDEAS.md "Establishing a Merit-Based Civil Service Clause" (Michael Hamilton).
- Why-an-amendment: the Pendleton Act / CSRA 1978 are statutes; Article II removal doctrine (Myers, Humphrey's Executor, Seila Law, Free Enterprise Fund) limits how far Congress can insulate — say what an amendment would do that a statute cannot.
