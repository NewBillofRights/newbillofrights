...
YOUR CATEGORY: Fair single-member districting
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/FAIR_DISTRICTING_CANDIDATE.md
...
- Overlap discipline is the whole task: Target 6 (Redistricting) already covers the once-per-decade rule with a post-2030 effective date; REDISTRICTING_RESEARCH.md §"Held back" lists exactly the two layers this candidate would add — the anti-favoritism floor (the Rucho reversal) and the neutral-authority / commission principle — with numbers (AP-NORC 2023 ~half of R call gerrymandering a "major problem"; commissions 82% overall but 57% R in 2021; 38–19 trust preference 2025; only 18% of D would keep California's commission at the cost of seats; Ohio Issue 1 2024 lost 54–46). Read that section, verify its numbers at the sources, and evaluate THIS candidate as "the held-back layers of Target 6": does either clear the bar as a standalone or companion clause?
- Search for the newest polling on partisan-fairness standards and independent commissions with party breakdowns (Pew, AP-NORC, YouGov, Marquette 2024–2026; the 2025 mid-decade redistricting fights produced fresh polling — Common Cause 2025 is in the corpus as advocacy-commissioned; label it). Ballot results: Michigan 2018 Prop 2 (61%), Colorado 2018 Y/Z (71%), Missouri 2018 Clean Missouri (62%) then 2020 Amendment 3 partial repeal (51%), Ohio 2024 Issue 1 (defeated 54–46), Utah Prop 4 2018 (50.3%) — verify on Ballotpedia; note red/blue/purple spread.
- Failure modes: high-topline/low-floor on commissions among R; regime coding (each party's enthusiasm for fairness standards tracks who holds the maps — show it with dated numbers if they exist); framing dependency ("who may not draw" vs "who must draw").
- Why-an-amendment: Rucho v. Common Cause (2019) — partisan gerrymandering claims non-justiciable federally; only an amendment (or state constitutions) can supply a standard. Cite supreme.justia.com.
- Recommendation is likely "hold as held-back layer of Target 6" or "fold" — say which and why.
- Candidate since: 2026-08-06.

## Return value (your final message must be ONLY this JSON, nothing else)

{"slug": "fair-districting",
 "file": "research/candidates/FAIR_DISTRICTING_CANDIDATE.md",
