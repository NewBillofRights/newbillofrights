...
CLAUSE privacy-deletion-right: privacy-deletion-right
Privacy AMENDMENT: Privacy (research memo: research/PRIVACY_RESEARCH.md; site page: /amendments/privacy)
INTENDED rejected clause unless the evidence surprises (the parent memo gives no return condition; substantiate the rejection or name a path back): rejected clause unless the evidence surprises (the parent memo gives no return condition; substantiate the rejection or name a path back)
OUTPUT (create; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/clauses/PRIVACY_DELETION_RIGHT_CLAUSE.md
...
3. The parent research memo's "Held back" / "What we left out" passages for this clause, plus its Review Additions; the parent's amendment page section "What we left out" (site/src/content/amendments/privacy.mdx).
...
5. One candidate memo for register (research/candidates/APPOINTMENT_DEFAULT_CANDprivacy-deletion-rightATE.md, §3–§5) and COPY_VOICE_GUprivacy-deletion-rightE.md "Nonpartisan discipline".
...
## Template (exact H2s)
# <Clause title> — Clause Memo (Privacy)
*Held back in research/PRIVACY_RESEARCH.md; tracked as a rejected clause unless the evidence surprises (the parent memo gives no return condition; substantiate the rejection or name a path back) clause of the Privacy amendment from 2026-08-18. Every figure verified against the linked source.*
...
{"id":"privacy-deletion-right","file":"research/candidates/clauses/PRIVACY_DELETION_RIGHT_CLAUSE.md","status":"candidate|rejected|fold","words":<n>,"floor":<n or null>,"verdict":"","gate":"<2–6 words>","pollQuestion":{"wording":"<verbatim>","followUps":["..."],"threshold":"<e.g. ≥60% in both parties>"},"decisiveNumber":{"proposal":"","dem":0,"rep":0,"ind":null,"overall":null,"pollster":"","year":0,"url":""} or null,"unverified":["..."],"notes":"..."}
