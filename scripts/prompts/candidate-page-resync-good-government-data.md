...
PAGE (edit only this file): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/candidates/good-government-data.mdx
MEMO (the only source of facts and URLs): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/GOOD_GOVERNMENT_DATA_CANDIDATE.md
...
## Do
- Compare every number, date, count, and claim on the page against the memo as it now stands. Where the memo changed, change the page (prose AND footnote), including the frontmatter `summary` and `gate` if the gate result or floor changed. SPECIFIC CHANGE Corrections: Economist/YouGov Aug 1–4 2025 wave is 42% trust / 45% distrust (page may say 46%), cited to YouGov's own page; March 6–8 2025 baseline 53% trust (n=1,120). Roll Call 484 (Evidence Act, 356–17): Republicans 182–17, Democrats 174–0. H.R. 4907: sponsor + 5 cosponsors, all Democratic. USAFacts/Harris 2017: fieldwork June 30–July 5 2017, n=2,521, and it DOES publish a party split on one item — 'information about government expenditures and outcomes is biased' 76% overall, 81% R / 72% D / 76% I. Update figures where they appear. for this page: Corrections: Economist/YouGov Aug 1–4 2025 wave is 42% trust / 45% distrust (page may say 46%), cited to YouGov's own page; March 6–8 2025 baseline 53% trust (n=1,120). Roll Call 484 (Evidence Act, 356–17): Republicans 182–17, Democrats 174–0. H.R. 4907: sponsor + 5 cosponsors, all Democratic. USAFacts/Harris 2017: fieldwork June 30–July 5 2017, n=2,521, and it DOES publish a party split on one item — 'information about government expenditures and outcomes is biased' 76% overall, 81% R / 72% D / 76% I. Update figures where they appear.
...
{"slug": "good-government-data", "changed": ["one line per change made"], "gateChanged": <true|false>, "summary": "<final frontmatter summary>", "gate": "<final frontmatter gate>", "words": <body word count>, "flags": ["anything the editor should look at"]}
