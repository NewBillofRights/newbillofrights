...
PAGE (edit only this file): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/candidates/expand-house.mdx
MEMO (the only source of facts and URLs): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/HOUSE_EXPANSION_CANDIDATE.md
...
## Do
- Compare every number, date, count, and claim on the page against the memo as it now stands. Where the memo changed, change the page (prose AND footnote), including the frontmatter `summary` and `gate` if the gate result or floor changed. SPECIFIC CHANGE Frederick 2008 (Knowledge Networks, Sept 13–19 2006, n=1,020) crosstabs now verified: costs-named item 18.9% increase / 61.9% keep / 19.3% decrease with R 11.3% / D 23.7% / I 22.7% — the depth test moves from 'never tested' to 'tested once and failed' and the R floor record is now three readings (11% 2006, 21% 2018, 23% 2023). Verasight/New America 2026: party split confirmed NOT published; verbatim wording and five-point distribution (18.3 strongly support / 36.0 somewhat / 15.3 somewhat oppose / 11.8 strongly / 18.6 not sure). H.R. 622 REAL House Act (118th) had 2 cosponsors, both Democrats. Update 'Where it stands' (depth) and the evidence. for this page: Frederick 2008 (Knowledge Networks, Sept 13–19 2006, n=1,020) crosstabs now verified: costs-named item 18.9% increase / 61.9% keep / 19.3% decrease with R 11.3% / D 23.7% / I 22.7% — the depth test moves from 'never tested' to 'tested once and failed' and the R floor record is now three readings (11% 2006, 21% 2018, 23% 2023). Verasight/New America 2026: party split confirmed NOT published; verbatim wording and five-point distribution (18.3 strongly support / 36.0 somewhat / 15.3 somewhat oppose / 11.8 strongly / 18.6 not sure). H.R. 622 REAL House Act (118th) had 2 cosponsors, both Democrats. Update 'Where it stands' (depth) and the evidence.
...
{"slug": "expand-house", "changed": ["one line per change made"], "gateChanged": <true|false>, "summary": "<final frontmatter summary>", "gate": "<final frontmatter gate>", "words": <body word count>, "flags": ["anything the editor should look at"]}
