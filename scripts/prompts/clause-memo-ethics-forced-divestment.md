...
CLAUSE ethics-forced-divestment: ethics-forced-divestment
Ethics AMENDMENT: Ethics (research memo: research/ETHICS_RESEARCH.md; site page: /amendments/ethics)
INTENDED rejected clause (69% "goes too far", Bloomberg 2016, no party split — verify; substantiate; path back or none): rejected clause (69% "goes too far", Bloomberg 2016, no party split — verify; substantiate; path back or none)
OUTPUT (create; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/clauses/ETHICS_FORCED_DIVESTMENT_CLAUSE.md
...
5. One candidate memo for register (research/candidates/APPOINTMENT_DEFAULT_CANDethics-forced-divestmentATE.md, §3–§5) and COPY_VOICE_GUethics-forced-divestmentE.md "Nonpartisan discipline".
...
*Held back in research/ETHICS_RESEARCH.md; tracked as a rejected clause (69% "goes too far", Bloomberg 2016, no party split — verify; substantiate; path back or none) clause of the Ethics amendment from 2026-08-18. Every figure verified against the linked source.*
...
{"id":"ethics-forced-divestment","file":"research/candidates/clauses/ETHICS_FORCED_DIVESTMENT_CLAUSE.md","status":"candidate|rejected|fold","words":<n>,"floor":<n or null>,"verdict":"","gate":"<2–6 words>","pollQuestion":{"wording":"<verbatim>","followUps":["..."],"threshold":"<e.g. ≥60% in both parties>"},"decisiveNumber":{"proposal":"","dem":0,"rep":0,"ind":null,"overall":null,"pollster":"","year":0,"url":""} or null,"unverified":["..."],"notes":"..."}
