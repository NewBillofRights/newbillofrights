...
YOUR CATEGORY: Abortion
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/rejected/ABORTION_REJECTED.md
...
- Framings to test: (a) a constitutional right to abortion / "codify Roe" amendment; (b) a "right to life"/fetal-personhood amendment; (c) "leave it to the states" (which is the status quo, not an amendment). Get party breakdowns on each from Pew (abortion legal in all/most cases, by party — Pew's tracker, most recent wave), Gallup (May 2024/2025/2026 Values & Beliefs: legal under any/certain/no circumstances by party; "constitutional right" items if asked), AP-NORC, and any 2025–2026 poll asking specifically about a constitutional amendment (e.g., Morning Consult/Cato via Newsweek June 2026 "how Americans would change the Constitution", Economist/YouGov June 2026 abortion items — both already cited in POLLING_RESEARCH.md for other topics; check whether they include abortion-amendment items).
- Ballot results 2022–2024 as evidence of framing dependence: Kansas Aug 2022 (59–41 against removing protection), Ohio Issue 1 Nov 2023 (56.8%), Michigan Prop 3 2022 (56.7%), Florida Amendment 4 Nov 2024 (57% but failed 60% threshold), Missouri Amendment 3 2024 (51.6%), Nebraska/South Dakota 2024 (rights measures failed) — official SoS results or Ballotpedia; note that state results are majorities, not the two-thirds/three-fourths supermajorities an amendment needs, and that they split by state partisanship.
- The failing test is high-topline/low-floor on BOTH directions (a rights amendment fails the R floor; a life amendment fails the D floor) plus the "abuse-vs-remedy" logic does not apply — there is no consensus principle. Also flag the trap in SELECTION_METHOD §11: autonomy-language privacy is the Griswold/Roe root, which is why the privacy target is drafted in informational terms only.

## Return value (your final message must be ONLY this JSON, nothing else)

{"slug": "abortion",
 "file": "research/rejected/ABORTION_REJECTED.md",
