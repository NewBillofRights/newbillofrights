...
- Length: 700–1,100 words of body prose (excluding footnotes) — candidate pages carry 'where it stands' and 'what would move it' in both directions, so they run longer than rejected pages (550–850). Every sentence load-bearing.
