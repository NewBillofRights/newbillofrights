...
YOUR CATEGORY: FCC and independent-agency independence
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/AGENCY_INDEPENDENCE_CANDIDATE.md
...
- Corpus: YouGov 30-policy battery Sept 2025 (pulling licenses of critical networks: 12% support / 74% oppose; R 22/61) via Mediaite — find YouGov's own page; Economist/YouGov via The Hill 13/68; Marquette Nov 2025 for-cause removal protections 71% (39R/89D/71I); Marquette May 20–26 2026 (Trump v. Slaughter framing) 73% say statutes may set removal requirements — 54R/72I/93D, and 66% say the president may NOT remove Fed governors (Trump v. Cook) — 40R/68I/92D. Verify on Marquette PDFs. This is the abuse-vs-remedy gap AND a moving R floor (39→54 in six months) — report the movement and the regime-coding risk.
- Legal record is central to why-an-amendment: Humphrey's Executor (1935), Seila Law (2020), Collins (2021), Trump v. Wilcox (2025 stay), Trump v. Slaughter (decided or pending in OT2025 — check the Supreme Court's site and report the actual status/holding as of today with a citation) — if the Court has narrowed/overruled Humphrey's, a statute cannot restore for-cause protection and only an amendment can; state that precisely.
- Contributor draft: AMENDMENT_IDEAS.md "Authorizing Independent Agency Insulation" (Michael Hamilton) — Congress may create independent offices and restrict removal without cause. Note the category title says FCC but the real proposal is independent-agency insulation generally; say so.
- Symmetry: binds both parties' presidents; each side's abuse examples exist (pair or use none). Existential test: argue neutrally.
- Candidate since: 2026-08-06.

## Return value (your final message must be ONLY this JSON, nothing else)

{"slug": "fcc-independence",
 "file": "research/candidates/AGENCY_INDEPENDENCE_CANDIDATE.md",
