...
CLAUSE term-limits-uniformity: term-limits-uniformity
Term Limits AMENDMENT: Term Limits (research memo: research/TERM_LIMITS_RESEARCH.md; site page: /amendments/term-limits)
INTENDED candidate (drafting-counsel gate, not a survey gate — say so): candidate (drafting-counsel gate, not a survey gate — say so)
OUTPUT (create; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/clauses/TERM_LIMITS_UNIFORMITY_CLAUSE.md
...
3. The parent research memo's "Held back" / "What we left out" passages for this clause, plus its Review Additions; the parent's amendment page section "What we left out" (site/src/content/amendments/term-limits.mdx).
...
5. One candidate memo for register (research/candidates/APPOINTMENT_DEFAULT_CANDterm-limits-uniformityATE.md, §3–§5) and COPY_VOICE_GUterm-limits-uniformityE.md "Nonpartisan discipline".
...
## Template (exact H2s)
# <Clause title> — Clause Memo (Term Limits)
*Held back in research/TERM_LIMITS_RESEARCH.md; tracked as a candidate (drafting-counsel gate, not a survey gate — say so) clause of the Term Limits amendment from 2026-08-18. Every figure verified against the linked source.*
...
{"id":"term-limits-uniformity","file":"research/candidates/clauses/TERM_LIMITS_UNIFORMITY_CLAUSE.md","status":"candidate|rejected|fold","words":<n>,"floor":<n or null>,"verdict":"","gate":"<2–6 words>","pollQuestion":{"wording":"<verbatim>","followUps":["..."],"threshold":"<e.g. ≥60% in both parties>"},"decisiveNumber":{"proposal":"","dem":0,"rep":0,"ind":null,"overall":null,"pollster":"","year":0,"url":""} or null,"unverified":["..."],"notes":"..."}
