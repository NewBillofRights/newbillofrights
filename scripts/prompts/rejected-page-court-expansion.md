...
CATEGORY: Supreme Court Expansion
SOURCE MEMO (the only source of facts and URLs for this page): /Users/michaelhamilton/Documents/newbillofrights/research/rejected/COURT_EXPANSION_REJECTED.md
OUTPUT FILE (overwrite the placeholder; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/rejected/court-expansion.mdx
...
{"slug": "court-expansion", "verdict": "39% Republican floor (Marquette, May 2026; 18–27% R in Pew and YouGov) — high-topline/low-floor, incumbent/regime coding, symmetry, and why-an-amendment all fail — path back only if an independent poll shows ≥45% support in both parties for a size rule written to bind both sides, sustained across a change in the Court's appointing-party majority; none identified.", "floor": 39, "floorNote": "39% R favor increasing the number of justices, Marquette Law School Poll May 20–26, 2026 (forced-choice; 62% D, 52% I, 50/50 overall) — the most favorable independent reading; Pew July 2023 27% R / 66% D; YouGov July 2024 18% R / 59% D (37/42/21 not sure)", "decisiveNumber": {"proposal": "Increase the number of Supreme Court justices — Marquette Law School Poll, May 2026", "dem": 62, "rep": 39, "ind": 52, "overall": 50, "pollster": "Marquette Law School Poll", "year": 2026, "url": "https://law.marquette.edu/assets/community/poll/MLSPSC32/MLSPSC32PressRelease_CourtIssues.pdf"}, "failedTests": ["high-topline/low-floor", "incumbent/regime coding", "framing dependency", "why-an-amendment (expansion is statutory; only a fixed-at-nine rule needs an amendment, and that is a different, single-party proposal)", "symmetry"], "framingsThatClear": ["Fixed terms instead of life tenure for justices — 73% R / 87% D — Marquette May 2026 (routed to the Term Limits amendment)", "Enforce a strict ethics code for justices — 88% R / 93% D — Marquette Oct 2024 (routed to the Ethics amendment)"], "pathBack": "Reopen only if an independent pollster shows ≥45% in each party for a size rule written to bind both parties, replicated after the Court's appointing-party majority has changed hands, and a version is introduced with cosponsors from both parties.", "notes": "The category now holds two mirror-image, single-party proposals in Congress (a fixed-at-nine amendment reported from committee on a party-line vote in June 2026; a 13-justice bill introduced May 2026), which the memo uses to show symmetry and why-an-amendment failures. Officeholder names only in citations."}
...
{"slug": "court-expansion", "words": <body word count>, "footnotes": <count>, "chart": <true|false>, "failedTest": "<as written>", "summary": "<as written>", "flags": ["<anything the editor should look at: a claim you were unsure how to phrase neutrally, a memo figure that looked inconsistent, etc.>"]}
