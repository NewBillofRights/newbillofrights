...
YOUR CATEGORY: Election Technology & Modernization
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/rejected/ELECTION_TECHNOLOGY_REJECTED.md
...
- As filed by Austin Burns: revise the electoral process for 250 years of technological change; secure mobile/online voting via quantum cryptography. The one-line reason: "not bipartisan and not popular."
- Evidence: polls on internet/online/mobile voting (Pew, e.g., 2020 "would you support voting online" if it exists; YouGov 2020–2024 online-voting items; AP-NORC; academic surveys) — most show majorities opposed, with party splits; get the numbers. Contrast with the technology items that ARE bipartisan (paper ballot backups, post-election audits, voting-machine certification — e.g., Pew/YouGov/Bipartisan Policy Center polls) and note those are statutory (Help America Vote Act, EAC standards) — the why-an-amendment test fails: nothing here needs constitutional text; Article I §4 already lets Congress regulate the manner of federal elections.
- Also cite the security consensus (National Academies 2018 "Securing the Vote" recommends against internet voting; DHS/CISA/FBI/EAC/NIST 2020 risk assessment on electronic ballot return) as the reason the "popular" test fails on the merits of the specific proposal — factual, not partisan.
- Failure modes: not popular (topline), partisan-coded where split, fails why-an-amendment. Path back: "none identified as an amendment; statutory track."
