...
YOUR CATEGORY: Age limits for the judiciary and Congress
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/AGE_LIMITS_CANDIDATE.md
...
- SELECTION_METHOD §10 records this as the strongest candidate (76% floor). Corpus: Pew Oct 2023 — max age for elected officials 79% (82R/76D); max age for SCOTUS justices 74% (68R/82D); CBS/YouGov Sept 2023 77% (79R/76D), plurality would set the cap at 70; AP-NORC July 2023 67% for justices; YouGov May 2025 presidential age cap 64R/88D (a flip from 2022–23). Verify each on the pollster's page and search for 2024–2026 updates (Pew, YouGov, AP-NORC, Gallup, Marquette on justices) — age-of-leaders salience changed in 2024–25; report whether the supermajority held and whether the partisan intensity migrated with each party's standard-bearer.
- Failure-mode checks: (a) support drops ~10 points when a specific cutoff is named — quantify from the crosstabs; (b) regime/incumbent coding — does each party's support track the age of its own leaders? show it with dated numbers.
- Overlap discipline: Target 2 (Term Limits — Congress + judiciary) is where this most likely lives; TERM_LIMITS_RESEARCH.md may already discuss age caps — read the relevant part and say precisely whether an age cap is a companion clause there or a standalone amendment. Note the mechanical difference: a term limit is a count, an age cap is a date; the traps (a 70 cap disqualifies sitting members, retroactivity/grandfathering, "age discrimination" objections, mid-term aging-out mechanics).
- Why-an-amendment: Powell v. McCormack (1969) and U.S. Term Limits v. Thornton (1995) — qualifications for Congress cannot be added by statute or by states; judicial life tenure is Art. III "good Behaviour" — an age cap on judges plainly needs an amendment. Cite supreme.justia.com.
- Existential test: is leader age a threat to the future of the country, or a preference? Report the arguments neutrally. Symmetry: binds both parties by construction.
- Candidate since: 2026-08-06.

## Return value (your final message must be ONLY this JSON, nothing else)

{"slug": "age-limits",
 "file": "research/candidates/AGE_LIMITS_CANDIDATE.md",
