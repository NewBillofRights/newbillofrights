...
YOUR CATEGORY: Eliminate Qualified Immunity for Policing
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/rejected/QUALIFIED_IMMUNITY_REJECTED.md
...
- Corpus section "Rejected 2026-08-06: Eliminate Qualified Immunity for Policing" in POLLING_RESEARCH.md has the evidence with URLs (Cato/YouGov July 2020 63% / 42R; Pew June 2020 66% / 45R; Data for Progress 2021; UMass Amherst April 2021 decline) and a Flagged correction: the accountability framing is 79% overall (64% R / 75% I / 91% D), not 84% — the memo you write must use the verified 79% figure. Verify each on the source page.
- Search hard for anything newer than 2021 (2022–2026 national polls on qualified immunity or suing police — e.g., YouGov, Gallup's policing items, Pew's 2023–2025 policing surveys, Cato 2023–2025). If nothing exists, that IS the finding (staleness test) — say so and log what you searched.
- Legal/legislative facts: QI is judge-made (Harlow v. Fitzgerald 1982; Pearson v. Callahan 2009 — cite supreme.justia.com); state-level ends/limits (Colorado SB 20-217 2020; New Mexico Civil Rights Act 2021; others — cite official statute pages or NCSL); the George Floyd Justice in Policing Act House vote (2021, 220–212 — congress.gov). Why-an-amendment: QI is a doctrine interpreting 42 U.S.C. §1983, so a statute can end it — the why-an-amendment test is weak; say so as part of the gate result.
- Path back per CATEGORIES.md: accountability framing + fresh (2026+) fieldwork clearing ~60% R.

## Return value (your final message must be ONLY this JSON, nothing else)

{"slug": "qualified-immunity",
 "file": "research/rejected/QUALIFIED_IMMUNITY_REJECTED.md",
