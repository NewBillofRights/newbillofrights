...
CLAUSE pardon-congressional-disapproval: pardon-congressional-disapproval
Limited Presidential Pardon Reform AMENDMENT: Limited Presidential Pardon Reform (research memo: research/PARDON_RESEARCH.md; site page: /amendments/pardon-reform)
INTENDED candidate: candidate
OUTPUT (create; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/clauses/PARDON_CONGRESSIONAL_DISAPPROVAL_CLAUSE.md
...
3. The parent research memo's "Held back" / "What we left out" passages for this clause, plus its Review Additions; the parent's amendment page section "What we left out" (site/src/content/amendments/pardon-reform.mdx).
...
5. One candidate memo for register (research/candidates/APPOINTMENT_DEFAULT_CANDpardon-congressional-disapprovalATE.md, §3–§5) and COPY_VOICE_GUpardon-congressional-disapprovalE.md "Nonpartisan discipline".
...
## Template (exact H2s)
# <Clause title> — Clause Memo (Limited Presidential Pardon Reform)
*Held back in research/PARDON_RESEARCH.md; tracked as a candidate clause of the Limited Presidential Pardon Reform amendment from 2026-08-18. Every figure verified against the linked source.*
...
{"id":"pardon-congressional-disapproval","file":"research/candidates/clauses/PARDON_CONGRESSIONAL_DISAPPROVAL_CLAUSE.md","status":"candidate|rejected|fold","words":<n>,"floor":<n or null>,"verdict":"","gate":"<2–6 words>","pollQuestion":{"wording":"<verbatim>","followUps":["..."],"threshold":"<e.g. ≥60% in both parties>"},"decisiveNumber":{"proposal":"","dem":0,"rep":0,"ind":null,"overall":null,"pollster":"","year":0,"url":""} or null,"unverified":["..."],"notes":"..."}
