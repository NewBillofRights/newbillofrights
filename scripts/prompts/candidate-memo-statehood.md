...
YOUR CATEGORY: Statehood for DC and Puerto Rico
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/STATEHOOD_CANDIDATE.md
...
- Treat DC and Puerto Rico as TWO gate results inside one memo (POLLING_RESEARCH.md says "poll separately"; the evidence differs sharply). Section 3 must give a floor and verdict for each. SELECTION_METHOD §10 currently records DC at 13% R (Yahoo/YouGov March 2021) — "effectively rejected on evidence but not yet formally moved" — and PR at 41% R (YouGov Oct 2024); Gallup July 2019 66% (45R/83D) for PR; Data for Progress March 2021 (advocacy) is the DC high mark. Verify each on the pollster's page.
- Search hard for anything 2023–2026 (Gallup, YouGov, Pew, Morning Consult tracking); national polling on both dried up after 2023 — say so if it is still true.
- Legislative record: H.R. 51 (117th) DC statehood House vote April 22, 2021 (216–208, party-line — verify via clerk.house.gov/GovTrack); Puerto Rico Status Act H.R. 8393 (117th) House vote Dec 15, 2022 (233–191 with some R support — verify); PR's own plebiscites (2012, 2017, 2020, Nov 2024 — official CEE results; the 2024 statehood share ~56–58% — verify).
- Why-an-amendment: admission of states is a statute (Art. IV §3) — the amendment question is only real for DC (23rd Amendment / the federal district). Say plainly that the why-an-amendment test is weak for PR and different for DC.
- Symmetry test: statehood is understood as adding senators — the coding is the whole problem; report each party's stated reasons using pollster wording.
- Recommendation should probably differ by jurisdiction; say so.
