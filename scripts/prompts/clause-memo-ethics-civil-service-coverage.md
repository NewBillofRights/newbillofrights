...
CLAUSE ethics-civil-service-coverage: ethics-civil-service-coverage
Ethics AMENDMENT: Ethics (research memo: research/ETHICS_RESEARCH.md; site page: /amendments/ethics)
INTENDED rejected clause (support drops 86%→40% when extended to all federal employees, UMD 2023 — verify; substantiate; path back or none): rejected clause (support drops 86%→40% when extended to all federal employees, UMD 2023 — verify; substantiate; path back or none)
OUTPUT (create; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/clauses/ETHICS_CIVIL_SERVICE_COVERAGE_CLAUSE.md
...
3. The parent research memo's "Held back" / "What we left out" passages for this clause, plus its Review Additions; the parent's amendment page section "What we left out" (site/src/content/amendments/ethics.mdx).
...
5. One candidate memo for register (research/candidates/APPOINTMENT_DEFAULT_CANDethics-civil-service-coverageATE.md, §3–§5) and COPY_VOICE_GUethics-civil-service-coverageE.md "Nonpartisan discipline".
...
## Template (exact H2s)
# <Clause title> — Clause Memo (Ethics)
*Held back in research/ETHICS_RESEARCH.md; tracked as a rejected clause (support drops 86%→40% when extended to all federal employees, UMD 2023 — verify; substantiate; path back or none) clause of the Ethics amendment from 2026-08-18. Every figure verified against the linked source.*
...
{"id":"ethics-civil-service-coverage","file":"research/candidates/clauses/ETHICS_CIVIL_SERVICE_COVERAGE_CLAUSE.md","status":"candidate|rejected|fold","words":<n>,"floor":<n or null>,"verdict":"","gate":"<2–6 words>","pollQuestion":{"wording":"<verbatim>","followUps":["..."],"threshold":"<e.g. ≥60% in both parties>"},"decisiveNumber":{"proposal":"","dem":0,"rep":0,"ind":null,"overall":null,"pollster":"","year":0,"url":""} or null,"unverified":["..."],"notes":"..."}
