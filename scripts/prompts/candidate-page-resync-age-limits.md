...
PAGE (edit only this file): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/candidates/age-limits.mdx
MEMO (the only source of facts and URLs): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/AGE_LIMITS_CANDIDATE.md
...
## Do
- Compare every number, date, count, and claim on the page against the memo as it now stands. Where the memo changed, change the page (prose AND footnote), including the frontmatter `summary` and `gate` if the gate result or floor changed. SPECIFIC CHANGE Fox News July 7–10 2024 crosstabs found: mandatory retirement age for justices 81% overall — 71% R / 77% I / 92% D; 18-year terms 78% — 68% R / 76% I / 89% D. The judicial half now has two independent pollsters at 68–71% R. H.J.Res. 87 (118th, Rep. James, R-MI), a maximum-age (75) joint resolution, had zero cosponsors and died in committee; not reintroduced. Update the judicial evidence and 'What would move it' where the memo did. for this page: Fox News July 7–10 2024 crosstabs found: mandatory retirement age for justices 81% overall — 71% R / 77% I / 92% D; 18-year terms 78% — 68% R / 76% I / 89% D. The judicial half now has two independent pollsters at 68–71% R. H.J.Res. 87 (118th, Rep. James, R-MI), a maximum-age (75) joint resolution, had zero cosponsors and died in committee; not reintroduced. Update the judicial evidence and 'What would move it' where the memo did.
...
{"slug": "age-limits", "changed": ["one line per change made"], "gateChanged": <true|false>, "summary": "<final frontmatter summary>", "gate": "<final frontmatter gate>", "words": <body word count>, "flags": ["anything the editor should look at"]}
