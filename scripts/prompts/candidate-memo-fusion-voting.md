...
YOUR CATEGORY: Fusion voting
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/FUSION_VOTING_CANDIDATE.md
...
- Corpus: unpolled nationally; Protect Democracy explainers as proxy. Search hard for any poll with a party breakdown (YouGov/Protect Democracy or state polls in NJ, KS, WI, MI 2023–2026 where fusion litigation/ballot efforts ran; Data for Progress — flag advocacy). Legal record: Timmons v. Twin Cities Area New Party (1997) — states may ban fusion (why-an-amendment answer: only an amendment overrides Timmons; but fusion is also permitted by state statute today in NY/CT — say the statutory path exists); state litigation 2023–2026 (New Jersey Moderate Party appellate ruling; Kansas United Kansas; Wisconsin United Wisconsin — report actual outcomes with citations, no guessing).
- Existential test: is fusion a threat-level fix or a party-mechanics preference? Report the argument each way. Symmetry: works for a center-right or center-left third party equally by construction — say so and note it is unpolled.
- Contributor: Michael Hamilton (AMENDMENT_IDEAS.md). Recommendation likely "hold — unpolled" or "reject on why-an-amendment/existential" — pick one and justify.
