...
PAGE (edit only this file): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/candidates/statehood.mdx
MEMO (the only source of facts and URLs): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/STATEHOOD_CANDIDATE.md
...
## Do
- Compare every number, date, count, and claim on the page against the memo as it now stands. Where the memo changed, change the page (prose AND footnote), including the frontmatter `summary` and `gate` if the gate result or floor changed. SPECIFIC CHANGE The page's 'Staleness: nothing national since April 2021' is now false: Strength In Numbers/Verasight Feb 18–20 2026 (n=1,566) asked DC and PR statehood — DC 32% support / 36% oppose / 32% not sure; PR 51% / 24%; party figures published only as NET support (DC net −25 R / −6 I / +15 D; PR net −3 R / +21 I / +55 D) — nets, not a floor. Data for Progress DC crosstab now verified at the source: 34% R support / 56% oppose, 51% I, 74% D. Update accordingly; verdicts unchanged. for this page: The page's 'Staleness: nothing national since April 2021' is now false: Strength In Numbers/Verasight Feb 18–20 2026 (n=1,566) asked DC and PR statehood — DC 32% support / 36% oppose / 32% not sure; PR 51% / 24%; party figures published only as NET support (DC net −25 R / −6 I / +15 D; PR net −3 R / +21 I / +55 D) — nets, not a floor. Data for Progress DC crosstab now verified at the source: 34% R support / 56% oppose, 51% I, 74% D. Update accordingly; verdicts unchanged.
...
{"slug": "statehood", "changed": ["one line per change made"], "gateChanged": <true|false>, "summary": "<final frontmatter summary>", "gate": "<final frontmatter gate>", "words": <body word count>, "flags": ["anything the editor should look at"]}
