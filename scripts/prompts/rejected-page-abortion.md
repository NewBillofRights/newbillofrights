...
CATEGORY: Abortion
SOURCE MEMO (the only source of facts and URLs for this page): /Users/michaelhamilton/Documents/newbillofrights/research/rejected/ABORTION_REJECTED.md
OUTPUT FILE (overwrite the placeholder; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/rejected/abortion.mdx
...
{"slug": "abortion", "verdict": "25% (Republicans) on a federal amendment protecting a right to abortion, UMass Amherst/YouGov Oct 2024 — Weak; high-topline/low-floor in both directions (a rights amendment loses Republicans, a life/personhood amendment loses Democrats) and no symmetric abuse-vs-remedy principle to draft around — path back: none identified; would need ≥45% in both parties for one specific amendment text.", "floor": 25, "floorNote": "25% R for a federal constitutional amendment that protects a woman's right to choose to have an abortion (87% D / 50% I / 56% overall), UMass Amherst/YouGov national poll, Oct 11–16 2024, n=1,500; opposite direction: national ban 15% overall, 7% D / 28% R, same poll", "decisiveNumber": {"proposal": "Federal constitutional amendment protecting a right to abortion (UMass Amherst/YouGov, Oct 2024)", "dem": 87, "rep": 25, "ind": 50, "overall": 56, "pollster": "UMass Amherst / YouGov", "year": 2024, "url": "https://www.umass.edu/poll/media/113/download"}, "failedTests": ["high-topline/low-floor (both directions)", "framing dependency (state-ballot and leave-it-to-states framings are not the federal amendment)", "symmetry / veil-of-ignorance (no abuse-vs-remedy consensus principle)"], "framingsThatClear": [], "pathBack": "None identified; reopening requires an independent national poll showing at least 45% in both parties for one specific amendment text, sustained across two waves under different administrations — no wave 2022–mid-2026 comes close and the party gap is widening (Pew: 24 pts in 2007 to 48 pts in 2026).", "notes": "Chart the UMass Amherst/YouGov Oct 2024 amendment item (87 D / 25 R / 50 I). In the same paragraph give the opposite-direction number (national ban 7% D / 28% R, same poll) so the page reads symmetric: each direction fails the other party's floor. Mention the privacy amendment's informational-only framing as a consequence of this rejection (the memo's Section 5 does). This is the most sensitive page on the site: pollster wording only, no view on the merits, no contested labels."}
...
{"slug": "abortion", "words": <body word count>, "footnotes": <count>, "chart": <true|false>, "failedTest": "<as written>", "summary": "<as written>", "flags": ["<anything the editor should look at: a claim you were unsure how to phrase neutrally, a memo figure that looked inconsistent, etc.>"]}
