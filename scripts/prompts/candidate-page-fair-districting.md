...
CATEGORY: Fair single-member districting
SOURCE MEMO (the only source of facts and URLs for this page): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/FAIR_DISTRICTING_CANDIDATE.md
OUTPUT FILE (overwrite the placeholder; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/candidates/fair-districting.mdx
...
{"slug": "fair-districting", "file": "research/candidates/FAIR_DISTRICTING_CANDIDATE.md", "candidateSince": "2026-08-06", "words": 3666,
 "status": "57% (Republicans) on 'it is bad for the country when one political party controls how voting districts are drawn,' Noble Predictive Insights for Common Cause (advocacy), Aug–Sept 2025 — Moderate on the best available number, and no independent poll has ever asked about either operative mechanism — held by the abuse-vs-remedy gap, why-an-amendment partly satisfied by Target 6 already, and a ballot record that runs against the polling — recommendation: hold (gate: independent poll of the 'who may not draw' wording and of the Florida anti-favoritism text, each clearing 60% R).",
 "floor": 57, "floorNote": "57% R (76D/72I), diagnosis wording, Noble/Common Cause Aug 26–Sept 2 2025 — advocacy, a diagnosis not a remedy; on the mechanisms the category is Unpolled", "verdict": "Moderate",
 "decisiveNumber": {"proposal": "States should not be allowed to draw districts that intentionally favor one party (Economist/YouGov 2026)", "dem": 74, "rep": 69, "ind": 70, "overall": 71, "pollster": "Economist/YouGov", "year": 2026, "url": "https://yougov.com/en-us/articles/54644-most-americans-say-partisan-gerrymandering-should-not-be-allowed-april-24-27-2026-economist-yougov-poll"},
 "openTests": ["unpolled remedy (neither anti-favoritism floor nor neutral-authority principle asked independently with party split)", "abuse-vs-remedy gap", "depth (18% of D would keep commission at cost of seats)", "high-topline/low-floor unquantified", "framing dependency (69–71% R condemnation vs 38% R institutional choice)", "symmetry open on neutral-authority layer"],
 "gate": "Remedy unpolled; support collapses when priced",
 "framingsThatClear": ["'States should not be allowed to draw districts that intentionally favor one party' — 69% R (71% overall) — Economist/YouGov Apr 24–27 2026 — a condemnation, not a rule", "'Nonpartisan commissions rather than the party in power' — 71% R in R-controlled states (82% overall; no national R split) — NBC/SurveyMonkey Aug–Sept 2025", "Florida Amendment 6 anti-favoritism text — 62.93% against 60% threshold, 2010"],
 "wouldMoveIn": "Two independent national polls, forward-looking and both-parties, each clearing 60% R — one on the federalized Florida anti-favoritism wording, one on the negative 'who may not draw' neutral-authority wording — surviving a costs-named follow-up ('even if your party wins fewer seats'); or a fairness-standard/commission ballot measure passing after 2024 on clean language in a state whose legislature opposed it.",
 "wouldMoveOut": "A replicated independent finding that the R floor on either operative wording is below 45%, or a re-run trade-off question showing both parties collapsing when seats are the price.",
 "recommendation": "hold — anti-favoritism layer passes existential and why-an-amendment cleanly (Rucho), but neither mechanism has an independent party-broken-out number and the one trade-off experiment shows a 52-point collapse; measure before folding; if it clears 60% R the natural home is a third clause in Target 6 using the Florida wording, with neutral-authority held longer.",
 "notes": "Category name conflates: single-member districting is already federal statute (2 U.S.C. §2c) and would foreclose the PR candidate — memo reads the category as the held-back layers of Target 6. Corpus discrepancies: 'Center Square Voters' Voice Aug 2025' trust figures are Noble for The Center Square June 1–4 2026; REDISTRICTING_RESEARCH pairs NBC 82% with R Street 57% as if same question — not; Ohio Issue 1 certified 53.71–46.29; Common Cause fieldwork Aug 26–Sept 2 2025 with mid-decade splits 51R/70D/60I."}

PAGE NOTE: this is the held-back layers of the Redistricting amendment (/amendments/redistricting) — say so up front. Chart the Economist/YouGov Apr 2026 condemnation item (74 D / 69 R / 70 I) with a caption making clear it is a condemnation, not a rule.
...
{"slug": "fair-districting", "words": <body word count>, "footnotes": <count>, "chart": <true|false>, "gate": "<as written>", "summary": "<as written>", "flags": ["<anything the editor should look at: a claim you were unsure how to phrase neutrally, a memo figure that looked inconsistent, etc.>"]}
