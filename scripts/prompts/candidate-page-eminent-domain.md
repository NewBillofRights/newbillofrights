...
CATEGORY: Eminent domain limits for private development
SOURCE MEMO (the only source of facts and URLs for this page): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/EMINENT_DOMAIN_CANDIDATE.md
OUTPUT FILE (overwrite the placeholder; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/candidates/eminent-domain.mdx
...
{"slug":"eminent-domain","status":"79% (Democrats) opposed to the Kelo holding, Saint Index / UMass Lowell Oct–Nov 2005 (85% R, 83% I) — Strong on the number, but the number is twenty-one years old; twelve state constitutional amendments passed at 60–86% (2006–2012) and a 376–38 House vote corroborate it; no independent national poll with a party split since; the deciding question is the existential-problem test.","verdict":"Strong — stale","gate":"Strong but stale; existential test open","decisiveNumber":{"proposal":"Oppose the Kelo decision (Saint Index / UMass Lowell, 2005)","dem":79,"rep":85,"ind":83}}

PAGE NOTE: this memo was written by a different session and uses slightly different section names (§4 'The three non-polling tests', §7 'Recommendation options', §8 Sources, a trailing 'Site summary'); the same rules apply — facts and URLs only from the memo, no recommendation on the page. Chart the Saint Index / UMass Lowell 2005 item (79 D / 85 R / 83 I) with '2005' in the caption and say plainly the national number is two decades old. Placeholder frontmatter: title as above, order 15, candidateSince "2026-08-18", memo research/candidates/EMINENT_DOMAIN_CANDIDATE.md.
...
{"slug": "eminent-domain", "words": <body word count>, "footnotes": <count>, "chart": <true|false>, "gate": "<as written>", "summary": "<as written>", "flags": ["<anything the editor should look at: a claim you were unsure how to phrase neutrally, a memo figure that looked inconsistent, etc.>"]}
