...
CATEGORY: Presidential Self-Pardon Ban
SOURCE MEMO (the only source of facts and URLs for this page): /Users/michaelhamilton/Documents/newbillofrights/research/rejected/SELF_PARDON_BAN_REJECTED.md
OUTPUT FILE (overwrite the placeholder; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/site/src/content/rejected/self-pardon-ban.mdx
...
{"slug": "self-pardon-ban", "verdict": "43% R (YouGov, Aug 2024, prohibiting a president from pardoning themself) — Weak floor; fails high-topline/low-floor, incumbent/beneficiary coding, and abuse-vs-remedy gap — path back is a forward-looking, both-parties re-poll clearing ~60% R, the first poll the foundation intends to commission on the pardon package.", "floor": 43, "floorNote": "43% R, prohibiting a president from pardoning themself (support), YouGov standalone Presidential Pardons survey, Aug 15–19 2024, n=1,130 (topline 64%, D 81%, I 67%; R 29% oppose / 27% not sure)", "decisiveNumber": {"proposal": "Prohibit a president from pardoning themself — YouGov, Aug 2024", "dem": 81, "rep": 43, "ind": 67, "overall": 64, "pollster": "YouGov", "year": 2024, "url": "https://ygo-assets-websites-editorial-emea.yougov.net/documents/Presidential_Pardons_poll_results.pdf"}, "failedTests": ["high-topline/low-floor", "incumbent/regime (beneficiary) coding", "abuse-vs-remedy gap", "framing dependency"], "framingsThatClear": ["'Inappropriate for a president to pardon themself' (norm, not a rule) — 63% R / 88% D / 77% I — YouGov Aug 2024", "'Unacceptable for presidents to pardon themselves if charged with a crime' (norm; 2018; party split only in AP write-up) — ~75% R / >90% D — AP-NORC June 2018 via AP/PBS"], "pathBack": "Commission an independent national poll asking the ban in forward-looking, both-parties wording alongside the pardon target's clauses, and reopen if Republican support reaches ~60% with Democrats above 60%; an independent replication of the 59% R norm figure or a court ruling on an actual self-pardon would also trigger review.", "notes": "IMPORTANT: the 82% D / 43% R figure was misattributed in the corpus to Economist/YouGov Dec 2025; the memo corrects this — the number is YouGov Aug 2024 (81/43). Use the memo's attribution. Recast 'moves with who is president' as 'moves with who the plausible beneficiary is' — under the same-party president in 2018 Republican opposition to self-pardons was ~75%. The category passes all three non-polling tests; the rejection is purely a polling result."}
...
{"slug": "self-pardon-ban", "words": <body word count>, "footnotes": <count>, "chart": <true|false>, "failedTest": "<as written>", "summary": "<as written>", "flags": ["<anything the editor should look at: a claim you were unsure how to phrase neutrally, a memo figure that looked inconsistent, etc.>"]}
