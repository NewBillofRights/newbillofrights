...
YOUR CATEGORY: FBI / DOJ independence
OUTPUT FILE (create it; touch nothing else): /Users/michaelhamilton/Documents/newbillofrights/research/candidates/DOJ_INDEPENDENCE_CANDIDATE.md
...
- Corpus: States United/YouGov May 2026 (60% disagree the president should direct DOJ at opponents; 36% R / 86% D / 53% I — advocacy-selected question, YouGov fieldwork; flag); States United June 2025; Marquette Nov 2025 (55%, 48R/65D "unjustified" cases) and Marquette May 20–26 2026 (55%, 53R/55I/58D — near-consensus diagnosis) — see the Review Additions in POLLING_RESEARCH.md; also the memo's contrast: 2022–24 cases against the then-former president split 77% R "unjustified" vs 86% D "justified". Verify all on Marquette's PDFs. This is the abuse-vs-remedy gap failure mode: both parties oppose the abuse; the STRUCTURAL remedy (constitutional DOJ independence, for-cause AG removal, Senate concurrence) is unpolled — search hard for any poll on the remedy (e.g., "should the Attorney General be independent of the president", "protect special counsels from removal" — Marquette, Pew, AP-NORC, YouGov 2018–2026; the 2018 special-counsel-protection polling exists — find it).
- Contributor drafts: AMENDMENT_IDEAS.md "Executive-accountability drafts" (Michael Hamilton) — insulating law enforcement, special counsel protections (statutory), DOJ firewall (statutory). Reddit: u/musashisamurai, u/Journey2Jess.
- Regime-coding: show which party says DOJ is "weaponized" flips with who holds the presidency (use dated numbers, pollster wording, no side-coded vocabulary — describe it as "the party out of power").
- Why-an-amendment: unitary-executive doctrine (Trump v. United States 2024 on the President's exclusive prosecutorial authority; Seila Law 2020; Myers 1926) means a statute insulating DOJ may be unconstitutional — that is a real why-an-amendment answer; state it with citations to supreme.justia.com.
- Symmetry: an independent DOJ binds both parties' presidents equally; but each side reads "independence" as protecting the other side's prosecutors — report that.
