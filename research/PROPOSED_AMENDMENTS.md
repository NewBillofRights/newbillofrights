# Proposed Amendments — Draft Language by Category
...
## Draft revision note (2026-08-18) — Term Limits

*Article 2 (Term Limits) was revised today at the founder's direction to fold in two accepted clauses from the candidate pipeline. No other article is changed. The evidence, gate checks, trap notes, and the updated package skeleton are recorded in [TERM_LIMITS_RESEARCH.md](TERM_LIMITS_RESEARCH.md) "Fold-in (2026-08-18)"; the two source memos are [AGE_LIMITS_CANDIDATE.md](candidates/AGE_LIMITS_CANDIDATE.md) and [APPOINTMENT_DEFAULT_CANDIDATE.md](candidates/APPOINTMENT_DEFAULT_CANDIDATE.md), both of which recommended exactly this disposition.*

**(a) Section 2 gains a confirmation-refusal default** — the knock-out variant from [APPOINTMENT_DEFAULT_CANDIDATE.md](candidates/APPOINTMENT_DEFAULT_CANDIDATE.md) §5: "The term of each such seat shall commence on the day appointed for it whether or not the seat is then filled, and until it is filled the Supreme Court shall exercise its judicial power as then constituted." Two words of the design carry it. Running each seat's eighteen years from its fixed calendar date rather than from a Justice's swearing-in means refusing to confirm subtracts from the eventual Justice's tenure instead of preserving the seat for a friendlier president; and the Court going on as constituted means a blockade produces a smaller Court rather than a paused calendar. This closes the gap [TERM_LIMITS_RESEARCH.md](TERM_LIMITS_RESEARCH.md) named in its own staggering-trap note — "decide the confirmation-refusal default (a Garland scenario)… so obstruction gains nothing permanent" — which a biennial-appointment design cannot leave open. The clause is **unpolled** and is folded as necessary drafting, not on a bipartisan floor; it is symmetric by construction, since it never asks which party holds the presidency or the Senate. It imposes no deadline, discharge rule, or scheduling requirement on the Senate and leaves the power to reject a nominee exactly where Article II puts it. The **deemed-confirmed** variant and any extension of a default rule to executive officers, ambassadors, or other judgeships are **not** adopted.

**(b) New Section 3 sets a judicial retirement age** — the judicial half of [AGE_LIMITS_CANDIDATE.md](candidates/AGE_LIMITS_CANDIDATE.md), folded as a backstop to the eighteen-year term, which by itself does not reach incapacity (an eighteen-year term beginning at fifty runs to sixty-eight). Republican floor 68% (Pew, 2023) to 71% (Fox News crosstabs, 2024), with Democrats at 82% and 92% in the same two readings; five certified state ballot results in both partisan leans, in which voters declined to loosen a judicial retirement age against near-unanimous referring legislatures. Drafting choices: "exercise the judicial power" parallels Section 2 and leaves the office and its removal rules untouched, the construction Canada uses to hold good behaviour and a retirement age in a single sentence; "after the end of the calendar year in which they attain" gives one predictable annual departure date; the age sits in the Constitution as a ceiling with Congress free to set a *lower* age for judges other than Justices, so the parameter can be tightened by law but never loosened for a sitting bench; and Justices and judges in office at ratification are exempt in the text of the clause itself, matching Section 2 and every version of a term-limits amendment that came close to passing. **The congressional half of the age-limits category is not adopted** — it remains a candidate pending a poll on a named age clearing 60% in both parties.

**(c) The anti-evasion clause moves from Section 3 to Section 4, unchanged in wording.** It stays last so that it plainly reaches every limitation the article imposes, the two new ones included: no later amendment or law may raise the retirement age for a bench then sitting, and none may suspend the seat-calendar rule for a Senate then sitting.

*Founder decisions 2026-08-18 (evening): retirement age kept as a 75 ceiling with Congress able to set an earlier age for judges below the Supreme Court; scope kept as all Article III judges; the 4–4 deadlock is accepted as the stated cost of the confirmation-refusal default and is stated plainly on the page.*

## Draft revision note (2026-08-18) — Article 9 (Thirteenth Amendment exception clause)

Adopted as Target 9 on the founder's decision of 2026-08-18 after the candidate memo ([candidates/THIRTEENTH_EXCEPTION_CANDIDATE.md](candidates/THIRTEENTH_EXCEPTION_CANDIDATE.md); 66% R / 85% D on state-measure wording, YouGov Oct 2024; state versions at 61–80% in Republican-voting states). Text is the "Draft text proposal" of [THIRTEENTH_EXCEPTION_RESEARCH.md](THIRTEENTH_EXCEPTION_RESEARCH.md) with the memo's recommended options: Section 1 restates the Thirteenth Amendment's first section with the punishment exception removed (rather than an express repealer); Section 2 keeps the compulsion sentence ("No person shall be compelled to labor by the infliction or threat of punishment") and the explicit "Congress or the States"; Section 3 carries the Thirteenth's enforcement clause forward verbatim. **Founder decisions 2026-08-18 (evening):** (a) the compulsion sentence is kept and will be polled as a split-sample arm; (b) a Section 4 two-year prospective effective date for corrections-department transition — **adopted by the founder 2026-08-18 (evening)**; (c) the two wording alternatives above. Held back with paths back in the research memo: a constitutional wage floor, a ban on work requirements as such, a private-hire prohibition.
